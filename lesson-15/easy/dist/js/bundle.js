...
/*!******************************************************!*\
  ...
  \******************************************************/
/*! no static exports found */function(e,o,s){"use strict";var t=s(/*! ./_library */"./node_modules/core-js/modules/_library.js"),n=s(/*! ./_export */"./node_modules/core-js/modules/_export.js"),r=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),u=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),d=s(/*! ./_iterators */"./node_modules/core-js/modules/_iterators.js"),c=s(/*! ./_iter-create */"./node_modules/core-js/modules/_iter-create.js"),l=s(/*! ./_set-to-string-tag */"./node_modules/core-js/modules/_set-to-string-tag.js"),i=s(/*! ./_object-gpo */"./node_modules/core-js/modules/_object-gpo.js"),a=s(/*! ./_wks */"./node_modules/core-js/modules/_wks.js")("iterator"),m=!([].keys&&"next"in[].keys()),j=function(){return this};e.exports=function(e,o,s,_,f,p,v){c(s,o,_);var h,y,g,b=function(e){if(!m&&e in S)return S[e];switch(e){case"keys":case"values":return function(){return new s(this,e)}}return function(){return new s(this,e)}},x=o+" Iterator",w="values"==f,k=!1,S=e.prototype,L=S[a]||S["@@iterator"]||f&&S[f],E=L||b(f),O=f?w?b("entries"):E:void 0,T="Array"==o&&S.entries||L;if(T&&(g=i(T.call(new e)))!==Object.prototype&&g.next&&(l(g,x,!0),t||"function"==typeof g[a]||u(g,a,j)),w&&L&&"values"!==L.name&&(k=!0,E=function(){return L.call(this)}),t&&!v||!m&&!k&&S[a]||u(S,a,E),d[o]=E,d[x]=j,f)if(h={values:w?E:b("values"),keys:p?E:b("keys"),entries:O},v)for(y in h)y in S||r(S,y,h[y]);else n(n.P+n.F*(m||k),o,h);return h}},"./node_modules/core-js/modules/_iter-detect.js":
/*!******************************************************!*\
...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";function t(){document.getElementsByTagName("nav")[0].addEventListener("click",function(e){e.preventDefault(),function(e,o){var s=performance.now();requestAnimationFrame(function t(n){var r=n-s;r>o&&(r=o),e(r),r<o&&requestAnimationFrame(t)})}(function(o){var s=e.target,t=document.getElementById(s.getAttribute("href").slice(1));window.scrollBy(0,t.getBoundingClientRect().top/20-3)},1500)})}s.r(o),s.d(o,"default",function(){return t})},"./src/js/parts/calc.js":
/*!******************************!*\
  !*** ./src/js/parts/calc.js ***!
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),s.d(o,"default",function(){return t});s(/*! core-js/modules/es6.regexp.constructor */"./node_modules/core-js/modules/es6.regexp.constructor.js");function t(){var e=document.querySelectorAll(".counter-block-input")[0],o=document.querySelectorAll(".counter-block-input")[1],s=document.getElementById("select"),t=document.getElementById("total"),n=0,r=0,u=0;t.innerHTML=0,e.addEventListener("change",function(){n=+this.value;var d=s.options[s.selectedIndex].value;if(u=4e3*(r+n)*d,""==e.value||0==e.value||""==o.value||0==o.value)t.innerHTML=0;else var c=0,l=setInterval(function(){t.innerHTML=c,(c+=50)>u&&clearInterval(l)},1)}),o.addEventListener("change",function(){r=+this.value;var d=s.options[s.selectedIndex].value;if(u=4e3*(r+n)*d,""==e.value||""==o.value||0==o.value||0==e.value)t.innerHTML=0;else var c=0,l=setInterval(function(){t.innerHTML=c,(c+=50)>u&&clearInterval(l)},1)}),e.addEventListener("keyup",function(){var o=new RegExp("[0-9]"),s=e.value,t=e.value.length;o.test(s.substr(-1))||(s=s.substring(0,t-1),e.value=s)}),o.addEventListener("keyup",function(){var e=new RegExp("[0-9]"),s=o.value,t=o.value.length;e.test(s.substr(-1))||(s=s.substring(0,t-1),o.value=s)}),s.addEventListener("change",function(){if(""==e.value||""==o.value||0==o.value||0==e.value)t.innerHTML=0;else{var s=4e3*(r+n)*this.options[this.selectedIndex].value;t.innerHTML=s}})}},"./src/js/parts/form.js":
/*!******************************!*\
  !*** ./src/js/parts/form.js ***!
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),s.d(o,"default",function(){return t});s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js");function t(){var e={loading:"url(../img/ajax-loader.gif)",success:"url(../img/checked.svg)",failure:"url(../img/failure.svg)"},o=document.querySelector(".main-form"),s=document.getElementsByTagName("input"),t=o.getElementsByTagName("input"),n=document.createElement("div"),r=document.querySelector(".form-contact"),u=r.getElementsByTagName("input");document.querySelector(".popup"),document.querySelector(".thanks");function d(o){o.addEventListener("submit",function(t){t.preventDefault(),o.appendChild(n),function(e){return new Promise(function(o,s){var t=new XMLHttpRequest;t.open("POST","server.php"),t.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),t.onreadystatechange=function(){t.readyState<4?o():4===t.readyState&&(200==t.status&&t.status<300?o():s())},t.send(e)})}(new FormData(o)).then(function(){n.style.backgroundImage=e.loading}).then(function(){n.style.backgroundImage=e.success}).catch(function(){return n.style.backgroundImage=e.failure}).then(function(){for(var e=0;e<s.length;e++)s[e].value=""})})}n.classList.add("status"),d(o),d(r),t[0].addEventListener("keyup",function(){var e=/^(\+|[0-9])/,o=t[0].value,s=t[0].value.length;o.length>1?e.test(o)&&/^[0-9]+$/.test(o.slice(1,o.length))||(o=o.substring(0,s-1),t[0].value=o):o.length<=1&&(e.test(o)||(t[0].value=""))}),u[1].addEventListener("keyup",function(){var e=/^(\+|[0-9])/,o=u[1].value,s=u[1].value.length;o.length>1?e.test(o)&&/^[0-9]+$/.test(o.slice(1,o.length))||(o=o.substring(0,s-1),u[1].value=o):o.length<=1&&(e.test(o)||(u[1].value=""))})}},"./src/js/parts/modal.js":
/*!*******************************!*\
  !*** ./src/js/parts/modal.js ***!
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";function t(){var e=document.querySelector(".more"),o=document.querySelector(".overlay"),s=document.querySelector(".popup-close");e.addEventListener("click",function(){o.style.display="block",this.classList.add("more-splash"),document.body.style.overflow="hidden"}),s.addEventListener("click",function(){o.style.display="none",e.classList.remove("more-splash"),document.body.style.overflow=""});document.querySelector(".description-btn");for(var t=document.getElementsByClassName("description-btn"),n=0;n<t.length;n++)t[n].addEventListener("click",function(){o.style.display="block",this.classList.add("more-splash"),document.body.style.overflow="hidden"})}s.r(o),s.d(o,"default",function(){return t})},"./src/js/parts/slider.js":
/*!********************************!*\
